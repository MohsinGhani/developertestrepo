...
export function themeToCssVars(theme: ThemeSettings): Record<string, string> {
  return {
    ...
    "--footer-text":
      theme.section_overrides?.footer?.text ?? theme.color_text_primary,
    "--footer-text-secondary":
      theme.section_overrides?.footer?.text_secondary ?? theme.color_text_body,
    "--footer-badge-bg":
      theme.section_overrides?.footer?.badge_bg ?? theme.color_secondary,
    "--footer-badge-text":
